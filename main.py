...
def add_individual(images_path):

    name = input("Enter your name :" + '\n')
    image_full_name = name + '.jpg'

    if os.path.exists(os.path.join(images_path, image_full_name)):
        print("This name exists already please try another name !")
        return
    ...
    if type(individual_check) != tuple:
        ...
        for image in os.listdir(images_path):
            ...
            known_face_names.append(image[:-5])
        ...
        if face_distances[best_match_index] > 0.40:
                cv2.imwrite(os.path.join(images_path, image_full_name), no_bounding_box_image)
        else:
    ...
    while True:
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                ...
                best_match_index = np.argmin(face_distances)
                if face_distances[best_match_index] < 0.40 and matches[best_match_index]:
